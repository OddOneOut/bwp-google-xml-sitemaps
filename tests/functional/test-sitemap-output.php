...
class BWP_Sitemaps_Sitemap_Output_Functional_Test extends BWP_Sitemaps_PHPUnit_WP_Functional_TestCase
{
	 ...
	 */
	public function test_should_format_datetime_correctly($current_timezone_string, $is_gmt_enabled)
	{
		self::set_wp_options(array('timezone_string' => $current_timezone_string));

		self::set_options(BWP_GXS_GENERATOR, array(
			'enable_gmt' => $is_gmt_enabled ? 'yes' : ''
		));
